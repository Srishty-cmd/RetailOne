...
const TopNavbar = ({ setDrawerOpen }) => {
  ...
  // Simple location matching for demo purpose title
  const getPageTitle = () => {
      ...
      <div className="flex items-center space-x-4 lg:space-x-6">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-border-main">
          <div className="hidden sm:block text-right">
            ...
            <span className="inline-flex items-center px-2 py-0.5 mt-0.5 rounded text-xs font-medium bg-primary/10 text-primary capitalize">
              Role: {role}
            </span>
          </div>
